...
class PlacesRemoteDataSource {
  ...
  PlacesRemoteDataSource(this.sessionToken);

  Future<List<SuggestionPlace>> fetchPlaceSuggestions(String input, String locale) async {
    final request = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$input&language=$locale&components=country:ua&key=$apiKey&sessiontoken=$sessionToken';
